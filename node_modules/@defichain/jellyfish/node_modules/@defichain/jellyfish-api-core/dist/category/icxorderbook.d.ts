 ...
 */
export declare class ICXOrderBook {
    ...
    listOrders(options: {
        orderTx: string;
    } & ICXListOrderOptions): Promise<Record<string, ICXOfferInfo>>;
    /**
...
export declare enum ICXOrderStatus {
    OPEN = "OPEN",
    CLOSED = "CLOSED",
    FILLED = "FILLED",
    EXPIRED = "EXPIRED"
...
export declare enum ICXHTLCType {
    CLAIM_DFC = "CLAIM DFC",
    DFC = "DFC",
    EXTERNAL = "EXTERNAL"
}
export declare enum ICXHTLCStatus {
    OPEN = "OPEN",
    CLAIMED = "CLAIMED",
    REFUNDED = "REFUNDED",
    EXPIRED = "EXPIRED",
...
//# sourceMappingURL=icxorderbook.d.ts.map